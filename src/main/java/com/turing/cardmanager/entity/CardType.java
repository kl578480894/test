...
public class CardType {
	...
	public String toString() {
		return "CardType [cardId=" + cardId + ", cardName=" + cardName
				+ ", cardNo=" + cardNo + ", cardYucunjine=" + cardYucunjine
				+ ", cardJiage=" + cardJiage + ", cardInfo=" + cardInfo
				+ ", cardLck=" + cardLck + ", cardState=" + cardState + "]";
	}
}