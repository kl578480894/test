...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		<label class="control-label label-default col-xs-12 " style="margin-bottom: 30px;">
			<h4>当前位置：入会方式 － 修改入会方式</h4>
		</label>
		<div class="container">
			<hr>
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="crfId" value="${codeRuhuifangshi.crfId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">入会方式名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="crfName" value="${codeRuhuifangshi.crfName}" placeholder="请输入入会方式名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">入会方式名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="crfInfo" value="${codeRuhuifangshi.crfInfo}" placeholder="请输入入会方式介绍" />
						</div>
					</div>
					<div class="form-group">
