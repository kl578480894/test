	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		...
		<div class="container">
			...
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="cspId" value="${codeShangpinpinpai.cspId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">商品品牌名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cspName" value="${codeShangpinpinpai.cspName}" placeholder="请输入商品品牌名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">商品品牌名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cspInfo" value="${codeShangpinpinpai.cspInfo}" placeholder="请输入商品品牌介绍" />
						</div>
					</div>
					<div class="form-group">
