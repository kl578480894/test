			...
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">用品类型名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cylName" placeholder="请输入用品类型名称" value="${yplx.cylName}" />
							<input class="form-control" name="cylId" type="hidden" value="${yplx.cylId}" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/yplx/edit.action");
		$("form").submit();
	}
